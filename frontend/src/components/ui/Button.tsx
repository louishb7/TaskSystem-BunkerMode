...
const variants = {
  ...
  secondary:
    "border-border bg-surface text-text-primary hover:border-control-border hover:bg-app",
  danger:
    "border-danger bg-danger text-white hover:border-danger-hover hover:bg-danger-hover",
  ghost:
    "border-transparent bg-transparent text-text-primary hover:border-border hover:bg-app",
}
